...
class Animation3(Node):
    ...
    def setup(self):
        ...
        self.direction:int = Compass.DOWN 
    ...
    def update(self) -> None:
        ...
        if self.frame_index is None:
            # if we are done with a non-repeating animation return to default
            self.active = False
    ...
    def set_state(self, state:str, direction=None):
        # TODO -4- evaluate if we need strict mode?
